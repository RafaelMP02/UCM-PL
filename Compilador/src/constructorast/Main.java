...
public class Main {
	public static void main(String[] args) throws Exception {
		...
		if (GestionErroresExp.NUM_ERRORES == 0) {
			...
			String archivo_wasm = removeExtension(file.getName())+ ".wat";
			BufferedWriter output = new BufferedWriter(new FileWriter("./Compilador/generator/"+archivo_wasm));
