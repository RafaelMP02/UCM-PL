...
public class Raiz implements NodoAST{
    ...
    void init(StringBuilder s, int x){  //para copiar en memoria
        s.append("(module \n").append(
                "(import \"runtime\" \"print\" (func $print (param i32)))\n").append(
                 "(import \"runtime\" \"read\" (func $read (result i32)))\n").append(
                "(memory 2000)\n" ).append(
                "(global $SP (mut i32) (i32.const ").append(4*x+4).append( ")) ;; start of stack\n" ).append(
                "(global $MP (mut i32) (i32.const ").append(4*x).append( ")) ;; mark pointer\n" ).append(
