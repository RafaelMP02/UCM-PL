...
Finalmente el último tipo de instrucción. Para la salida estándar está reservada la palabra \reserved{print} que imprime el contenido de una variable primitiva por la salida estándar. Para la entrada estándar, tenemos la palabra reservada \reserved{read} que de igual manera recoge el valor de una variable primitiva dada por la entrada estándar.
