...
\begin{algorithm}
	\Integer{} hola ::= 2; \comm{//Error léxico} \\
...
\begin{itemize}
	...
	\item \err{[Fila 5, Columna 10] Caracter inesperado: "\_"}
\end{itemize}
\newpage
...
El perimer error muestra que, al ser tomada la expresión funcional como una instrucción, no importa el tipo de retorno, y 
